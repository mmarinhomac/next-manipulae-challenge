...
describe('PlayerMobile', () => {  
  it('info map correctly', () => {  
    ...
    expect(Array.from(container.querySelectorAll('p'))[1].innerHTML).toContain(track.title)
    expect(Array.from(container.querySelectorAll('p'))[2].innerHTML).toContain(track.artist)
  })
})
